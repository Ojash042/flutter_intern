...
class _ProfileInfoPageState extends State<ProfileInfoPage>{
  ...
  .firstWhereOrNull((element) => element.email == loggedInEmail);
  ...
  print(currentUserDetails!.toJson());
  }
          ...
          child: Column(
              ...
              child: SizedBox(
                ...
                child: Column(children: [
                  ...
                  children: currentUserDetails!.educations.map((e) => Column(children: [
                    ...
                    Text('From ${e.startDate} - ${'From ${e.endDate}'}')],)).toList()
                  )
                ],),
                ),),
              ),
              ...
              child: Card(child: Padding(padding: const EdgeInsets.all(8),
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 15,),
                    Column(children: currentUserDetails!.workExperiences.map((e) => Column(children: [
                        Text(e.jobTitle),
            ...
            child: SizedBox(
              ...
              child: Column(children: [
                ...
                Column(children: currentUserDetails!.contactInfo.socialMedias.map((e) => Column(children: [
                  Text(e.title),
                  const SizedBox(height: 15,),
                  Text(e.url),
                  const SizedBox(height: 15,),

...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> loadAssets() async {
    ...
    sharedPreferences.getString("user_friends") == null? sharedPreferences.setString("user_friend",jsonEncode(jsonDecode(userFriendJson)["user_friend_list"])) : null;
  }
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          "/friendRequests": (context) => MultiBlocProvider(
                providers: [
                  BlocProvider.value(value: locator<UserFriendBloc>(),),
                  BlocProvider.value(value: locator<UserListBloc>(),),
                ],
